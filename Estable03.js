            ...
            if (found==null && bandera==false){
                ...
                console.log('MAC pero sin SN');    
                    ...
                    if (found.Log=="Esperando SN"){
                        ...
                        // create new id (basically +1 of last item object)
                        //let newId = itemIds.length > 0 ? Math.max.apply(Math, itemIds) + 1 : 1;
                        newIp = array.length > 1
                         ? Math.max.apply(Math, array) + 1 : 171;// create new order number (basically +1 of last item object)
                    ...
                    }  //Programacion normal arriba y reprogramacion hacia abajo
                    //else {
                        
                        if(reprogramacion==true){
                            console.log("bandera2: "+bandera2);
