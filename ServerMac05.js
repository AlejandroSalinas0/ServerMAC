            ...
            if (found==null && bandera==false){
                ...
                console.log('MAC pero sin SN');    
                    ...
                    if(controler=="Ready Network"){    
                        ...
                        //update  
                        SL.updateUserData(database, found, updated);   //actualizo y guardo todo
                    ...
                    //} //Test  
                        ...
                        if(reprogramacion==true){
                            ...
                            SL.updateUserData(database, found, updated);   //actualizo y guardo todo//actualizo y guardo todo
                        }
                    }
                }
            }
