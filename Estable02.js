            ...
            if (found==null && bandera==false){
                ...
                console.log('MAC pero sin SN');    
                    ...
                    //saveUserData(database);
                        ...
                        console.log(bandera, controler, updated, mac);
                        bandera=false;
                        controler='';
                        found='';
                        mac='';
                        ...
                        if(reprogramacion==true){
                            if(found.Log=="Configuracion inicial exitosa" || bandera2==true){
...
//Server mac estable version 2 todo bien excepto que tal vez tenga problemas para manejar varios clientes a la vez debido que guarda la mac y todo eso en el cache
// Probando aun el reprogramador un if se lo salta
